#!/bin/bash
# V4 Training - MPS Balanced Profile (Stable + Fast)
# Reduces crashes from large effective batch sizes

set -e

echo "=== V4 TWO-TOWER TRAINING (MPS BALANCED) ==="
echo "Started: $(date)"
echo ""
echo "🎯 Profile: BALANCED (--bs 16 --accum 4 = effective 64)"
echo "   Optimized for MPS stability with good throughput"
echo "   Expected: 20-30 min for 30 epochs"
echo ""
...
OUT_DIR="runs/twotower_v4_mps_balanced"
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
LOG_FILE="logs/twotower_v4_mps_balanced_$TIMESTAMP.log"
...
if [ $EXIT_CODE -eq 0 ]; then
  echo ""
  echo "=========================================="
  echo "✅ BALANCED TRAINING COMPLETED!"
  echo "=========================================="
  echo ""
