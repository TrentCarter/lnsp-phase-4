#!/bin/bash
# Start P1 Baseline Transformer on port 9007
...
export LVM_MODEL_PATH="artifacts/lvm/models/transformer_baseline_p1/best_model.pt"
...
# Launch service
echo "🚀 Starting P1 Baseline Transformer on port 9007..."
