#!/usr/bin/env bash
# Ingest ~1k FactoidWiki items end-to-end (PG + Neo4j + NPZ vectors)
# Usage: scripts/ingest_1k.sh [path/to/factoidwiki_1k.jsonl]
...
INPUT_JSONL=${1:-data/factoidwiki_1k_sample.jsonl}
ART_DIR=${ART_DIR:-artifacts}
NPZ_PATH=${NPZ_PATH:-$ART_DIR/fw1k_vectors.npz}
...
# Ingest
echo "▶️  Ingesting 1k items from $INPUT_JSONL"
