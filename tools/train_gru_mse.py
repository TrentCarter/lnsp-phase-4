#!/usr/bin/env python3
"""
Simple GRU Trainer for Debugging
"""
...
def main():
    parser = argparse.ArgumentParser(description='Simple GRU Trainer')
    ...
    model_config = {'input_dim': 768, 'd_model': 512, 'num_layers': 4, 'dropout': 0.0}
    model = create_model('gru', **model_config).to(device)
