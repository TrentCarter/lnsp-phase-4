...
Uses Gemini 2.5 Flash (or fallback) to decompose Code lane job cards into Manager tasks

Contract: Based on docs/contracts/DIRECTOR_CODE_SYSTEM_PROMPT.md
"""
import os
import json
...
class ManagerTaskDecomposer:
    ...
    def __init__(self):
        ...
        self.llm_provider = os.getenv("DIR_CODE_LLM_PROVIDER", "google")
        self.llm_model = os.getenv("DIR_CODE_LLM", "gemini-2.5-flash")
    ...
    def _build_decomposition_prompt(
        ...
        return f"""You are Dir-Code, the Director of the Code lane in a Polyglot Agent Swarm (PAS).

Your role is to decompose Code lane job cards into Manager-level tasks. Each Manager will coordinate 1-5 Programmers to complete their task.
...
Decompose this job card into Manager-level tasks. Follow these rules:
