#!/usr/bin/env python3
"""
Manager-Code-02 Service - Code Lane Task Breakdown
...
app = FastAPI(title="Manager-Code-02", version="1.0.0")
...
SERVICE_NAME = "Manager-Code-02"
SERVICE_PORT = 6142
AGENT_ID = "Mgr-Code-02"
PARENT_AGENT = "Dir-Code"
TIER = "manager"
LANE = "Code"

# LLM Configuration (load from env or config file)
PRIMARY_LLM = os.getenv("MGR_CODE_02_PRIMARY_LLM", "google/gemini-2.5-flash")
BACKUP_LLM = os.getenv("MGR_CODE_02_BACKUP_LLM", "anthropic/claude-haiku-4")
