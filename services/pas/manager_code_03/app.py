#!/usr/bin/env python3
"""
Manager-Code-03 Service - Code Lane Task Breakdown
...
app = FastAPI(title="Manager-Code-03", version="1.0.0")
...
SERVICE_NAME = "Manager-Code-03"
SERVICE_PORT = 6143
AGENT_ID = "Mgr-Code-03"
PARENT_AGENT = "Dir-Code"
TIER = "manager"
LANE = "Code"

# LLM Configuration (load from env or config file)
PRIMARY_LLM = os.getenv("MGR_CODE_03_PRIMARY_LLM", "google/gemini-2.5-flash")
BACKUP_LLM = os.getenv("MGR_CODE_03_BACKUP_LLM", "anthropic/claude-haiku-4")
