...
Uses Gemini 2.5 Flash (or fallback) to decompose Data lane job cards into Manager tasks

Contract: Based on docs/contracts/DIRECTOR_DATA_SYSTEM_PROMPT.md
"""
import os
import json
...
class ManagerTaskDecomposer:
    ...
    - Manager-level data task breakdown
    - Test requirements
    ...
    def __init__(self):
        ...
        self.llm_provider = os.getenv("DIR_DATA_LLM_PROVIDER", "anthropic")
        self.llm_model = os.getenv("DIR_DATA_LLM", "claude-sonnet-4-5-20250929")
    ...
    def _build_decomposition_prompt(
        ...
        return f"""You are Dir-Data, the Director of the Data lane in a Polyglot Agent Swarm (PAS).

Your role is to decompose Data lane job cards into Manager-level data tasks. Each Manager will coordinate 1-5 Programmers to complete their task.
...
Decompose this job card into Manager-level data tasks. Follow these rules:
