#!/usr/bin/env python3
"""
Manager-Docs-01 Service - Code Lane Task Breakdown
...
PRIMARY_LLM = os.getenv("MGR_DOCS_01_PRIMARY_LLM", "google/gemini-2.5-flash")
BACKUP_LLM = os.getenv("MGR_DOCS_01_BACKUP_LLM", "anthropic/claude-haiku-4")
