...
Uses Gemini 2.5 Flash (or fallback) to decompose Models lane job cards into Manager tasks

Contract: Based on docs/contracts/DIRECTOR_MODELS_SYSTEM_PROMPT.md
"""
import os
import json
...
class ManagerTaskDecomposer:
    ...
    - Manager-level training task breakdown
    - Test requirements
    ...
    def __init__(self):
        ...
        self.llm_provider = os.getenv("DIR_MODELS_LLM_PROVIDER", "anthropic")
        self.llm_model = os.getenv("DIR_MODELS_LLM", "claude-sonnet-4-5-20250929")
    ...
    def _build_decomposition_prompt(
        ...
        return f"""You are Dir-Models, the Director of the Models lane in a Polyglot Agent Swarm (PAS).

Your role is to decompose Models lane job cards into Manager-level training tasks. Each Manager will coordinate 1-5 Programmers to complete their task.
...
Decompose this job card into Manager-level training tasks. Follow these rules:
